...
public class DBFixup04 extends DefaultDbMigration {
	public static final int MAX_READ = 200;
	public static final int MAX_COMMIT = 25;
	
	public DBFixup04(String[] args) throws InvalidMigrationParametersException {
		super(args);
	}

	@Override
	public String getDescription() {
		return "Community Events DB Migration - Fixup 04";
	}

	public static void main(String[] argv) throws Exception {
		DBFixup04 inst = new DBFixup04(argv);
