...
public class DBFixup06 extends DefaultDbMigration {
	public static final int MAX_READ = 200;
	public static final int MAX_COMMIT = 25;
	
	public DBFixup06(String[] args) throws InvalidMigrationParametersException {
		super(args);
	}

	@Override
	public String getDescription() {
		return "Community Events DB Migration - Fixup 06";
	}

	public static void main(String[] argv) throws Exception {
		DBFixup06 inst = new DBFixup06(argv);
