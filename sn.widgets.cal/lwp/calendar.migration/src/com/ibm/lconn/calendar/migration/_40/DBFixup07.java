...
public class DBFixup07 extends DefaultDbMigration {

	public DBFixup07(String[] args) throws InvalidMigrationParametersException {
		super(args);
	}

	@Override
	public String getDescription() {
		return "Community Events DB Migration - Fixup 07";
	}

	public static void main(String[] argv) throws Exception {
		DBFixup07 inst = new DBFixup07(argv);
