...
begin
    execute immediate 'drop index CALENDAR.CA_CALENDAR_PK';
exception
...
alter table CALENDAR.CA_MEMBERSHIP add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENT add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTINSTANCE add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_SUBSTITUTION add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_RECURRENCE add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTINFO add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTTAG add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTTAGAGG add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTCOMMENT add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_EVENTFOLLOWING add (ORG_ID varchar(36) default 'a' not null);
alter table CALENDAR.CA_DELETION_HISTORY add (ORG_ID varchar(36) default 'a' not null);
commit;
...
alter table CALENDAR.CA_DELETION_HISTORY modify ORG_ID default null;
commit;
