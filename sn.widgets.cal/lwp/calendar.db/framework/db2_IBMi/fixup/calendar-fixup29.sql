...
CREATE TABLE CALENDAR.CA_USERMENTION (
    MENTION_UUID   VARCHAR(48) CCSID 1208 NOT NULL,
    OBJECT_ID      VARCHAR(48) CCSID 1208 NOT NULL,
    OBJECT_TYPE    INTEGER NOT NULL, -- 1: event, 2: instance, 3: comment
    CALENDAR_UUID  VARCHAR(48) CCSID 1208 NOT NULL,
    USER_UUID      VARCHAR(48) CCSID 1208 NOT NULL, 
    MENTIONEDBY    VARCHAR(48) CCSID 1208 NOT NULL, 
    CREATEDON      TIMESTAMP   NOT NULL,
    ORG_ID         VARCHAR(36) CCSID 1208 NOT NULL
);

ALTER TABLE CALENDAR.CA_USERMENTION
ADD CONSTRAINT CALENDAR.CA_USERMENTION_PK PRIMARY KEY (
	MENTION_UUID, ORG_ID
);
