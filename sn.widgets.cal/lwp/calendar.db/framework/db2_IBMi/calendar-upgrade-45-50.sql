...
alter table CALENDAR.CA_MEMBERSHIP add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENT add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTINSTANCE add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_SUBSTITUTION add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_RECURRENCE add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTINFO add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTTAG add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTTAGAGG add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTCOMMENT add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_EVENTFOLLOWING add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
alter table CALENDAR.CA_DELETION_HISTORY add column ORG_ID varchar(36) CCSID 1208 default 'a' not null;
commit;
