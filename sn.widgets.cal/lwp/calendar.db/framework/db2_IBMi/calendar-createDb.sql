...
CREATE TABLE CALENDAR.CA_SCHEMA (
    ...
    DBSCHEMAVER	VARCHAR(32) CCSID 1208	NOT NULL,
	RELEASEVER  VARCHAR(32) CCSID 1208 NOT NULL WITH DEFAULT '' 
	);
...
CREATE TABLE CALENDAR.CA_CALENDAR (
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	    NOT NULL,
	COMMUNITY_UUID	VARCHAR(36) CCSID 1208	    NOT NULL,
	COMMUNITY_NAME  VARCHAR(256) CCSID 1208	NOT NULL,
	...
	WIDGETID		VARCHAR(48) CCSID 1208,
	ORG_ID          VARCHAR(36) CCSID 1208 NOT NULL
	);
...
CREATE TABLE CALENDAR.CA_EVENT (
	...
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	NOT NULL,
	MODIFIEDBY		VARCHAR(36) CCSID 1208	NOT NULL,
	CREATEDBY		VARCHAR(36) CCSID 1208	NOT NULL,
	MODIFIEDON		TIMESTAMP	NOT NULL,
	CREATEDON		TIMESTAMP	NOT NULL,
	DFLTEVENTINFO	VARCHAR(36) CCSID 1208	NOT NULL,
...
CREATE TABLE CALENDAR.CA_EVENTINSTANCE (
	...
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	NOT NULL,
	EVENT_UUID		VARCHAR(36) CCSID 1208	NOT NULL,
	EVENTINFO_UUID	VARCHAR(36) CCSID 1208,
	STARTDATE		TIMESTAMP	NOT NULL,
	ENDDATE			TIMESTAMP	NOT NULL,
	MODIFIEDBY		VARCHAR(36) CCSID 1208,
...
CREATE TABLE CALENDAR.CA_RECURRENCE (
	EVENT_UUID		VARCHAR(36) CCSID 1208	NOT NULL,
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	NOT NULL,
	FREQUENCYCODE	CHAR(1) CCSID 1208		NOT NULL,
	INTERVAL		SMALLINT,
	UNTILRULE		TIMESTAMP,
	STARTDATE		TIMESTAMP	NOT NULL,
	ENDDATE			TIMESTAMP	NOT NULL,
...
CREATE TABLE CALENDAR.CA_EVENTINFO (
	...
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	NOT NULL,
	EVENT_UUID		VARCHAR(36) CCSID 1208	NOT NULL,
	DESCRIPTION	    CLOB(102400) CCSID 1208,
	LOCATION	    VARCHAR(256) CCSID 1208,
	NAME		    VARCHAR(256) CCSID 1208,
	ISALLDAY        SMALLINT,
...
CREATE TABLE CALENDAR.CA_DELETION_HISTORY (
	DELHISTORY_UUID	VARCHAR(36) CCSID 1208	NOT NULL,	
	CALENDAR_UUID	VARCHAR(36) CCSID 1208	NOT NULL DEFAULT '',
	OBJECT_TYPE		SMALLINT 	NOT NULL, -- 0 - EVENT, 1 - EXCEPTION INSTANCE
	OBJECT_UUID		VARCHAR(36) CCSID 1208 NOT NULL,
...
CREATE TABLE CALENDAR.CA_EVENTTAGAGG (
	TAGAGG_UUID		VARCHAR(36) CCSID 1208	 NOT NULL,
	CALENDAR_UUID	VARCHAR(36) CCSID 1208 NOT NULL,
	NAME	    	VARCHAR(256) CCSID 1208 NOT NULL,
...
CREATE TABLE CALENDAR.CA_EVENTCOMMENT (
	...
	CONTENT	    	CLOB(102400) CCSID 1208 NOT NULL,
...
CREATE TABLE CALENDAR.CA_EVENTFOLLOWING (
    ...
    CALENDAR_UUID	VARCHAR(36) CCSID 1208	 NOT NULL,
    EVENT_UUID		VARCHAR(36) CCSID 1208	 NOT NULL,
    EVENTITEM_UUID  VARCHAR(36) CCSID 1208  NOT NULL,
    EVENTITEM_TYPE	SMALLINT	 NOT NULL, -- 0: event, 1: instance
    ENDDATE			TIMESTAMP	 NOT NULL,
    USER_UUID		VARCHAR(36) CCSID 1208	 NOT NULL,
...
CREATE TABLE CALENDAR.CA_MISCDATA (
    NAME          	VARCHAR(256) CCSID 1208  NOT NULL,
    VAL       		VARCHAR(1024) CCSID 1208 NOT NULL,
    MODIFIEDON		TIMESTAMP	  NOT NULL
);
...
ADD CONSTRAINT CALENDAR.CA_SCHEMA_PK PRIMARY KEY (
	COMPKEY
);
...
ADD CONSTRAINT CALENDAR.CA_MISCDATA_PK PRIMARY KEY (
	NAME
);
...
INSERT INTO CALENDAR.CA_SCHEMA (COMPKEY, DBSCHEMAVER, RELEASEVER) VALUES ('CALENDAR', '34', '5.5.0.0.0');
